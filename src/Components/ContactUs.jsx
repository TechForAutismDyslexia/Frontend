...
export default function ContactUs() {
    return (
        <div className='p-1 mt-5'>
              <div className='container d-flex pt-4 flex-column border-2 border border-black rounded-4' style={{backgroundColor: "#c1d2c1"}} >
            <div className='fw-medium fs-5 ms-3' style={{ color: "green" }}>
                How can we help you?
            </div>
            <div className='p-3'>
                <div className='fw-semibold display-3'>
                    Contact Us
                </div>
                <div className='mt-3 fw-medium'>
                    we are here to help you with any queries <br />you have.
                    we look forward to hearing from you!
                </div>
                <div className='m-3 d-flex flex-column ps-3 gap-2'>
                    <div className=''>
                    ...
                    <div className=''>
                        ...
                        <a href="mailto:TADteam@gmail.com"> TADteam@gmail.com</a>
                    </div>
                    <div>
                        ...
                        <span> KMIT ,Narayanguda ,Hyderadad.</span>
                    </div>
