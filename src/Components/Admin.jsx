  ...
  return (
    <div className="container">
      ...
      <div className='d-flex justify-content-between align-items-center'>
        ...
        <div className=''>
          <button className='btn m-1 fw-bold' style={{backgroundColor:"rgb(100, 150, 200)"}} onClick={()=>navigate('/approveappointment')}>Approve Appointments</button>
          <button className='btn m-1 fw-bold' style={{backgroundColor:"rgb(100, 150, 200)"}} onClick={()=>navigate('/bookappointment')}>Book Appointment</button>
