...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="navbar navbar-expand-lg border border-2 border-dark rounded-4 m-3 fs-5" style={{backgroundColor:'rgb(100, 150, 200)'}}>
            <div className="container-fluid">
                <Link className="navbar-brand" to="/">
                    <img src={logo} style={{ borderRadius: '40px' }} className='border border-dark border-2' alt="Logo" height='50' width='50' />
